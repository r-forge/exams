...
<p>Proportion of variance explained (in percent): <input class='webex-solveme nospaces' data-tol='0.1' size='20' data-answer='["65.11"]'/></p>
<p>F-statistic: <input class='webex-solveme nospaces' data-tol='0.1' size='20' data-answer='["54.12"]'/></p>
<p>Characterize in your own words how the response <code>y</code> depends on the regressors <code>x1</code> and <code>x2</code>. <input class='webex-solveme' size='20' data-answer='["nil"]'/></p>
<p>Upload the R script you used to analyze the data. <input class='webex-solveme' size='20' data-answer='["nil"]'/></p>
</div>
...
<p>Proportion of variance explained (in percent): <input class='webex-solveme nospaces' data-tol='0.1' size='20' data-answer='["85.55"]'/></p>
<p>F-statistic: <input class='webex-solveme nospaces' data-tol='0.1' size='20' data-answer='["239.78"]'/></p>
<p>Characterize in your own words how the response <code>y</code> depends on the regressors <code>x1</code> and <code>x2</code>. <input class='webex-solveme' size='20' data-answer='["nil"]'/></p>
<p>Upload the R script you used to analyze the data. <input class='webex-solveme' size='20' data-answer='["nil"]'/></p>
</div>
<div class="webex-solution">
...
<p>Proportion of variance explained (in percent): <input class='webex-solveme nospaces' data-tol='0.1' size='20' data-answer='["77.84"]'/></p>
<p>F-statistic: <input class='webex-solveme nospaces' data-tol='0.1' size='20' data-answer='["94.85"]'/></p>
<p>Characterize in your own words how the response <code>y</code> depends on the regressors <code>x1</code> and <code>x2</code>. <input class='webex-solveme' size='20' data-answer='["nil"]'/></p>
<p>Upload the R script you used to analyze the data. <input class='webex-solveme' size='20' data-answer='["nil"]'/></p>
</div>
<div class="webex-solution">
