...
```{r include-pdf, echo=FALSE, results="hide"}
pdfs <- list.files("nops_pdf", pattern = "\\.pdf$", full.names = TRUE)
pngs <- include_pdf_screenshot(pdfs)
pdfs <- include_file(pdfs)
```

[![`r basename(pngs[1])`](`r pngs[1]`)](`r pdfs[1]`)
[![`r basename(pngs[2])`](`r pngs[2]`)](`r pdfs[2]`)
