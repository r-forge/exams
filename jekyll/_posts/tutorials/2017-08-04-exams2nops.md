...
First, we load the R `exams` package and then simply create a list of exercise file names.</p>
...
## [3] &quot;nops_scan_20170809180917.zip&quot;
</code></pre>

The resulting file [nops_scan_20170809180917.zip]({{ site.url }}/assets/posts/2017-08-04-exams2nops//nops_scan_20170809180917.zip) contains copies of the
