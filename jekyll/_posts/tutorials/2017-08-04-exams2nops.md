...
# Content
#
title: "Written Multiple-Choice Exams in R/exams"
...
![create]({{ site.url }}/images/written-create.svg){:width="30%"}

The first step in conducting a [written exam](/intro/written/) with multiple-choice
...
[![demo1.pdf]({{ site.url }}/assets/posts/2017-08-04-exams2nops/demo1.png)]({{ site.url }}/assets/posts/2017-08-04-exams2nops//demo1.pdf)
[![demo2.pdf]({{ site.url }}/assets/posts/2017-08-04-exams2nops/demo2.png)]({{ site.url }}/assets/posts/2017-08-04-exams2nops//demo2.pdf)
...
![print]({{ site.url }}/images/written-print.svg){:width="30%"}

Now you can print the PDFs for your exam.

* A small number of exams can easily be printed on a standard printer.
  Otherwise simply use a print shop.
* It is recommended _not_ to scale the printout (i.e., without "Fit to printable area")
  and to staple the exams in the top-left corner.
* By default the PDFs from `exams2nops()` have a blank second page for
  duplex printing. Then there is no content on the back of the exam sheet.
  If you want to print without duplex option, simply set `duplex = FALSE` when
  creating the PDFs with `exams2nops()`.


## Conduct exam

![exam]({{ site.url }}/images/written-exam.svg){:width="30%"}

The exam is conducted as usual. But if you used the possibilities of [dynamic exercises](/intro/dynamic/)
...
render them into a single PDF file. Practical recommendations:
...
[![nops_scan1.png]({{ site.url }}/assets/posts/2017-08-04-exams2nops/nops_scan1-thumb.png)]({{ site.url }}/assets/posts/2017-08-04-exams2nops//nops_scan1.png)
[![nops_scan2.png]({{ site.url }}/assets/posts/2017-08-04-exams2nops/nops_scan2-thumb.png)]({{ site.url }}/assets/posts/2017-08-04-exams2nops//nops_scan2.png)
...
<pre><code>## Loading required namespace: png
</code></pre>
...
<pre><code>## [1] &quot;nops_scan1.png&quot;               &quot;nops_scan2.png&quot;              
## [3] &quot;nops_scan_20170809014256.zip&quot;
</code></pre>

The resulting file [nops_scan_20170809014256.zip]({{ site.url }}/assets/posts/2017-08-04-exams2nops//nops_scan_20170809014256.zip) contains copies of the
...
![evaluate]({{ site.url }}/images/written-evaluate.svg){:width="30%"}
...
The resulting file is [Exam-2015-07-29.csv]({{ site.url }}/assets/posts/2017-08-04-exams2nops//Exam-2015-07-29.csv).
...
<pre><code>## Loading required namespace: base64enc
</code></pre>
...
The evaluated data can be inspected by opening [nops_eval.csv]({{ site.url }}/assets/posts/2017-08-04-exams2nops//nops_eval.csv) in some spreadsheet
...
[![Exam-2015-07-29-jane_doe.html]({{ site.url }}/assets/posts/2017-08-04-exams2nops/Exam-2015-07-29-jane_doe.png)]({{ site.url }}/assets/posts/2017-08-04-exams2nops//Exam-2015-07-29-jane_doe.html)
[![Exam-2015-07-29-ambi_dexter.html]({{ site.url }}/assets/posts/2017-08-04-exams2nops/Exam-2015-07-29-ambi_dexter.png)]({{ site.url }}/assets/posts/2017-08-04-exams2nops//Exam-2015-07-29-ambi_dexter.html)
