...
\begin{answerlist}
  ...
  \item If the income decreases by 2% and thus the demand for a good decreases by 3%, it is called a luxury good.
  ...
  \item A Giffen good is a special case of an inferior good where demand increases if the price of the good increases.
