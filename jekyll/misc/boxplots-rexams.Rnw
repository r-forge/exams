...
bx <- boxplot(y ~ x, data = dat, xlab = "", ylab = "", col = "#1f7a7a", pch = 21, bg = "#1f7a7a", border = "#1f7a7a", lwd = 2, lty = 1)
lines(c(0.6, 1.4), rep(bx$stats[3,1], 2), lwd = 2, col = "#ffffff")
lines(c(1.6, 2.4), rep(bx$stats[3,2], 2), lwd = 2, col = "#ffffff")
@
