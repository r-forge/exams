...
```{r, echo=FALSE, results="hide"}
file.remove(Sys.glob(c("Exam-*.csv", "nops_eval.*")))
unlink(c("nops_pdf", "nops_scan", "jane_doe", "ambi_dexter"), recursive = TRUE, force = TRUE)
```
