...
`r include_asset(system.file("nops", "hr.dcf", package = "exams"))` | Croatian  | [Krunoslav Juraić](http://www.irb.hr/eng/People/Krunoslav-Juraic)      |
...
`r include_asset(system.file("nops", "pt.dcf", package = "exams"))` | Portugese | [Mauricio Calvão](http://www.if.ufrj.br/~orca/) & Fabian Petutschnig   |
