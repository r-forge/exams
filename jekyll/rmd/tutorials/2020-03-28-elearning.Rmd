...
```{r, echo=FALSE}
elearn_exam <- c("swisscapital.Rnw", "deriv.Rnw", "ttest.Rnw",
  "boxplots.Rnw", "function.Rnw", "lm.Rnw", "fourfold2.Rnw")
```
...
This yields the file `r include_asset("R-exams.xml")` that can be imported into Moodle.
...
The resulting output file is `r include_asset("R-exams.zip")`.
