...
if(runif(1) > 0.5) {
  ...
  explanations[1] <- paste0("The test statistic is $F = ", format(round(myanova[2,5], digits = 3), nsmall = 3),
...
solutions[3] <- r2 > r2a
explanations[3] <- paste0("The fraction of explained variance is $", format(round(r2, digits = 3), nsmall = 3), 
...
solutions[5] <- r2 < r2b
explanations[5] <- paste0("The fraction of explained variance is $", format(round(r2, digits = 3), nsmall = 3), 
...
```{r boxplots, echo = FALSE, results = "hide", fig.height = 4, fig.width = 7, fig.path = "", fig.cap = ""}
par(mar = c(4, 4, 1, 1))
...
Solutionlist
------------
* `r mchoice2text(solutions[1], markup = "markdown")`: `r explanations[1]`
* `r mchoice2text(solutions[2], markup = "markdown")`: `r explanations[2]`
* `r mchoice2text(solutions[3], markup = "markdown")`: `r explanations[3]`
* `r mchoice2text(solutions[4], markup = "markdown")`: `r explanations[4]`
* `r mchoice2text(solutions[5], markup = "markdown")`: `r explanations[5]`
