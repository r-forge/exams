...
```{r boxplot, echo = FALSE, results = "hide", fig.height = 4, fig.width = 5, fig.path = ""}
...
answerlist(questions, markup = "md")
```
...
answerlist(mchoice2text(solutions, markup = "md"), explanations, markup = "md")
```
