\begin{question}
Which of the following cities is the capital of the corresponding country?

\begin{answerlist}
  \item Lagos (Nigeria)
  \item S{\~a}o Paulo (Brazil)
  \item Toronto (Canada)
  \item Auckland (New Zealand)
  \item Istanbul (Turkey)
  \item Z{\"u}rich (Switzerland)
  \item Tokyo (Japan)
  \item New Delhi (India)
  \item Astana (Kazakhstan)
  \item Warsaw (Poland)
