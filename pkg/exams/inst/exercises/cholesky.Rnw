...
\begin{eqnarray*}
  A &= \Sexpr{toLatex(A)}.
\end{eqnarray*}
compute the matrix $L = (\ell_{ij})_{1 \leq i,j \leq \Sexpr{n}}$ from the Cholesky decomposition
\begin{eqnarray*}
  A &= L L^\top
\end{eqnarray*}
Which of the following statements are true?
\begin{answerlist}
  \item \Sexpr{mc$questions[1]}
  \item \Sexpr{mc$questions[2]}
  \item \Sexpr{mc$questions[3]}
  \item \Sexpr{mc$questions[4]}
  \item \Sexpr{mc$questions[5]}
\end{answerlist}
\end{question}
...
and hence:
\begin{answerlist}
  \item \Sexpr{mchoice2text(mc$solutions[1])}: \Sexpr{mc$explanations[1]}
  \item \Sexpr{mchoice2text(mc$solutions[2])}: \Sexpr{mc$explanations[2]}
  \item \Sexpr{mchoice2text(mc$solutions[3])}: \Sexpr{mc$explanations[3]}
  \item \Sexpr{mchoice2text(mc$solutions[4])}: \Sexpr{mc$explanations[4]}
  \item \Sexpr{mchoice2text(mc$solutions[5])}: \Sexpr{mc$explanations[5]}
\end{answerlist}
\end{solution}
