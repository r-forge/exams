...
## cloze type:
##   ":NUMERIC:=2.228:0.01~%50%1.960:0.01#Approximately normal instead of exact t solution."
...
sol <- ":NUMERICAL:=%s:0.01~%%50%%%s:0.1#Approximately normal instead of exact t solution."
