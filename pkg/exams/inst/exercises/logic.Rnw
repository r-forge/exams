...
include_tikz(tikz_gate(ops4[1]), name = "A",
  format = typ, width = "0.17 \\textwidth", library = tikz_gate_libraries)
@

&

<<echo=FALSE, results=tex>>=
include_tikz(tikz_gate(ops4[2]), name = "B",
  format = typ, width = "0.17 \\textwidth", library = tikz_gate_libraries)
@
...
<<echo=FALSE, results=tex>>=
include_tikz(tikz_gate(ops4[3]), name = "C",
  format = typ, width = "0.17 \\textwidth", library = tikz_gate_libraries)
@
...
<<echo=FALSE, results=tex>>=
include_tikz(tikz_gate(ops4[4]), name = "D",
  format = typ, width = "0.17 \\textwidth", library = tikz_gate_libraries)
@
...
include_tikz(tikz_truth_table(ops1), name = "table",
  format = typ, width = "0.1 \\textwidth", packages = "booktabs")
@
...
A = \textbf{\Sexpr{ops4[1]}},
B = \textbf{\Sexpr{ops4[2]}},
C = \textbf{\Sexpr{ops4[3]}},
D = \textbf{\Sexpr{ops4[4]}}.
