...
<<<<<<< .mine
  ...
  else paste("This is an interpretation of row percentages, but the table gives ",
||||||| .r1997
  explanations[4] <- if (solutions[4]) "This is the correct interpretation of row percentages."
  else paste("This is an interpretation of row percentages, but the table gives ",
=======
  explanations[4] <- if (solutions[4]) "This is the correct interpretation for row percentages."
  else paste("This is an interpretation for row percentaes, but the table provides ",
>>>>>>> .r2058
             percentage[variant], "percentages.")
} else {
