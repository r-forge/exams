...
create_table <- function() {
  ...
  matrix(c(city, suburb), nrow = 4,
         dimnames = list(Evaluation = c("very good", "good", "bad", "very bad"),
           Location = c("city center", "suburbs")))
}
public <- create_table()
...
if (question == 1) {
  ...
  "live in the city center.") else paste("The value in row 4 and column~2 in the percentage table indicates:", prop_public[4,2], 
...
if (question == 1) {
  if (runif(1) > 0.5) {
    questions[4] <- paste("The value in row~2 and column~1 in the percentage table indicates:", prop_public[2,1], 
                          "percent of the respondents in the city center evaluated the public transportation as good.")
  } else {
  ...
  questions[4] <- paste("The value in row~3 and column~1 in the percentage table indicates:", prop_public[3,1], 
                        "percent of the respondents lived in the city center and evaluated",
...
\begin{question}
  ...
  inhabitants of the city center are more satisfied with public
