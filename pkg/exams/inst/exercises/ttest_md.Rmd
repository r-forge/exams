...
explanations[4] <- if (solutions[4]) paste("The test result is significant (p < 0.05)",
  ...
  ifelse(tt$p.value < 0.05, "", "The test result is not significant (p >= 0.05)."))
...
explanations[5] <- if (solutions[5]) paste("The test result is significant (p < 0.05)",
  ...
  ifelse(tt$p.value < 0.05, "", "The test result ist not significant (p >= 0.05)."))
```
...
Solutionlist
------------
* `r mchoice2text(solutions[1], markup = "md")`: `r explanations[1]`
* `r mchoice2text(solutions[2], markup = "md")`: `r explanations[2]`
* `r mchoice2text(solutions[3], markup = "md")`: `r explanations[3]`
* `r mchoice2text(solutions[4], markup = "md")`: `r explanations[4]`
* `r mchoice2text(solutions[5], markup = "md")`: `r explanations[5]`
