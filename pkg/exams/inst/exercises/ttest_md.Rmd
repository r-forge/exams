...
logical2text <- function(x) ifelse(x, "**True**", "**False**")
```
...
Solutionlist
------------
* `r logical2text(solutions[1])`: `r explanations[1]`
* `r logical2text(solutions[2])`: `r explanations[2]`
* `r logical2text(solutions[3])`: `r explanations[3]`
* `r logical2text(solutions[4])`: `r explanations[4]`
* `r logical2text(solutions[5])`: `r explanations[5]`
