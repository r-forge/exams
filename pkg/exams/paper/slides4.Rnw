...
{\bf Learning management}   & \emph{Moodle}, \emph{OpenOLAT}, \emph{ARSnova}, \dots & E-learning infrastructure 	     \\[0.18cm]
\hline
\end{tabular}
}
...
\textbf{Example:} Which of these are open-source learning management systems?
...
\verb|Answerlist|\\
\verb|----------|\\
\verb|* True. Canvas is developed by Instructure Inc. under the Affero General Public License Version 3.|\\
\verb|* True. Ilias is an open-source system released under the General Public License.Version 3.|\\
\verb|* True. Moodle is an open-source system released under the General Public License Version 3.|\\
\verb|* True. OLAT is developed by the University of Zurich under the Apache License 2.0 License.|\\
\verb|* False. Blackboard Learn is a commercial system developed by Blackboard Inc.|\\
\verb|* False. Brightspace is a commercial system developed by Desire2Learn.|\\
}
...
<<echo=FALSE, results=hide>>=
set.seed(2018-05-16)
exams2pdf("lms.Rmd", dir = ".", name = "slides4-lms-", template = "standalone.tex")
set.seed(2018-05-16)
...
\end{minipage}
\begin{minipage}[t]{0.6\textwidth}
\only<2>{\raisebox{-\height}{\fbox{\includegraphics[width=\textwidth]{slides4-lms-1}}}}%
