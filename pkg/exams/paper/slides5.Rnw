...
\begin{frame}
\frametitle{Example: Formative assessments}
...
\begin{frame}
\frametitle{Example: First-year mathematics}

\textbf{Structure:} Mandatory.
\begin{itemize}
  \item 2-hour lecture (VO), 500+ participants.
...
\begin{itemize}
  \item \emph{Learning:} Textbook (soon online), screencasts, slides.
...
\begin{frame}
\frametitle{Example: Data analytics}
...
\begin{itemize}
  ...
  \item \pkg{learnr}, \pkg{Particify}, \pkg{LOPS}, \dots
\end{itemize}
...
\textbf{Other:} \code{exams2pdf()}, \code{exams2html()}, \code{exams2moodle()}, \code{exams2canvas()}, \dots
...
\begin{itemize}
  ...
  \item Use university's learning management system, e.g., OpenOlat, Moodle, \dots
\end{itemize}
...
\textbf{2.~Create}
\begin{itemize}
  \item Draw random replications from exercise templates, e.g., via \texttt{exams2openolat()}, \dots
...
\textbf{More details:} \url{https://www.R-exams.org/tutorials/first_steps/}
...
\begin{tabular}{ll}
  Web           & \url{https://www.R-exams.org/} \\
  CRAN          & \url{https://CRAN.R-project.org/package=exams} \\
  StackOverflow & \url{https://stackoverflow.com/questions/tagged/r-exams} \\
  Forum         & \url{https://R-Forge.R-project.org/forum/?group_id=1337} \\
  Mastodon      & \href{https://fosstodon.org/@zeileis}{@zeileis@fosstodon.org} \\
