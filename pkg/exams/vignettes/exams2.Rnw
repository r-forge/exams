...
by a \pkg{Firefox} browser). More details on how to customize \pkg{exams}-generated
questions for \pkg{Moodle} are provided in Appendix~\ref{sec:moodlecustom}.
\readme{Appendix still needs to be written.}
