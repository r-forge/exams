...
ans <- c(sprintf("True. %s is a direct neighbor of %s.", frmt(primary, display), frmt(country, "name")),
  sprintf("False. %s does not share a border with %s.", frmt(secondary, display), frmt(country, "name")))  
...
Question
========
Which of the following countries are direct neighbors (i.e., sharing a border) of `r frmt(country, display)`?
