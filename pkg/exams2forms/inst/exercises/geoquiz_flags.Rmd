...
# Control arguments
## TODO ## exams_continent <- "North America"
## TODO ## exams_display   <- "flag" # name, flag, or combined
exams_continent <- sample(unique(data$continent), 1)
exams_display   <- sample(c("name", "flag", "combined"), 1)
