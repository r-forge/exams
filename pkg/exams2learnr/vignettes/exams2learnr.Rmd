...
verions of each of these exercises:
...
![Screenshot from run_quiz(c("capitals.Rmd", "fruit.Rmd", "function.Rmd"))](screenshots/run_quiz.png){width=100%}
...
readily provided within the R/exams package. This is represented
as a `learnr_text` object:
...
random replication, each of which is a list of `question` objects.
...
![Screenshot from learnr_quiz](screenshots/learnr_quiz.png){width=100%}
...
![Screenshot from learnr_questions](screenshots/learnr_questions_deriv.png){width=100%}
![Screenshot from learnr_questions](screenshots/learnr_questions_boxplots.png){width=100%}
