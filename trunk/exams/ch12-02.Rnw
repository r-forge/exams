...
walk generiert. Dazu wurden die Korrelogramme berechnet. Reihen und 
Korrelogramme sind unten - allerdings in einer {\it zufälligen Anordnung} - 
graphisch dargestellt. Die Reihen, wie auch die Korrelogramme wurden 
zufällig und unabhängig voneinander angeordnet. 
Aufgabe ist es jeder Reihe das richtige Korrelogramm zuzuordnen. 
...
\begin{itemize}
 ...
 \item {\it Autogregressives Modell:} ZB ein AR(1) lautet 
    ...
    Werte sind iA (auto-)korreliert. Dadurch können entweder längere 
    Zyklen, 
