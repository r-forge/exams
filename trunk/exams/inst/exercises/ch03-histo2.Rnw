...
Abb.\,\ref{fig:ch03-histo2} zeigt die Verteilung der Preise von Eigentumswohnungen (pro $m^2$). Welcher Quadrat\-meterpreis
...
for(i in 1:(iu-1))polygon(c(grenzen[i],grenzen[i+1],grenzen[i+1],grenzen[i],grenzen[i]),c(0,0,hoehen[i],hoehen[i],0),density=15,lty=3)
polygon(c(grenzen[iu],sol,sol,grenzen[iu],grenzen[iu]),c(0,0,hoehen[iu],hoehen[iu],0),density=15,lty=3)
