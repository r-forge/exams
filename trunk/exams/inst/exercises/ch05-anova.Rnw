...
questions[4] <- "Es kann nachgewiesen werden, dass die Bewertung der Testpersonen von ihrer Besch\\\\\"aftigung abh\\\\\"angt."
...
explanations[4] <- paste("Der $p$-Wert ist $", format.pval(myanova[2,6], digits = 3),
  ...
  "nachgewiesen werden, dass sich die Bewertungen nach Besch\\\\\"aftigung der Testperson unterscheiden.")
