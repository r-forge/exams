...
der Testperson, sind in Abbildung~\ref{fig:ch05-anova1} zu sehen.
...
@
\caption{\label{fig:ch05-anova1} Parallele Boxplots}
\end{center}
\end{figure}

Um zu analysieren, welchen Einfluss die Besch\"aftigung auf die Bewertung des Werbeplakats
