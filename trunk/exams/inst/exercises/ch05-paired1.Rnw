...
study <- if(paired) paste(
  ...
  product[3], "\\\\emph{mit} Logo und fragt nach einer Bewertung auf einer Skala von 0 bis 10.",
  ...
  "Anschlie{\\\\ss}end soll jeder Kunde", product[2], "auf einer Skala von 0 bis 10 bewerten."
)
...
f\"ur \Sexpr{product[3]} \"uberhaupt mit bzw.\ ohne Logo?
