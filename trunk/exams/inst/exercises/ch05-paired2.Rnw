...
study <- if(paired) paste(
  ...
  "aus der alten herk\\\\\"ommlichen Verpackung kosten und fragt nach einer Bewertung auf einer Skala von 0 (schlecht) bis 10 (gut).",
  ...
  "Anschlie{\\\\ss}end soll jeder Kunde den", product, "auf einer Skala von 0 (schlecht) bis 10 (gut) bewerten."
)
...
questions[1] <- paste("Die h\\\\\"oheren Bewertungen erh\\\\\"alt der", product, "mit der neuen Fitness-Verpackung.")
