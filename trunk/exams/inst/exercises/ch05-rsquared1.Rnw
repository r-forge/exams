...
y <- score10(rnorm(sum(n), mean = rep(sample(seq(from = sample(20:60, 1), by = 1, length = sample(15:25, 1)), 4)/10, n),
...
wurden getrennt nach Besch\"aftigung der Testpersonen in folgender Tabelle zusammengefasst.
...
Welcher Anteil der Gesamtstreuung der Bewertungen l\"asst sich auf Unterschiede
