...
Autos gemessen. Die resultierenden Daten sind in Abbildung~\ref{fig:ch06-wilcoxplot1}
zu sehen.
...
exam_rankplot(dat)
@
\caption{\label{fig:ch06-wilcoxplot1} Beobachtete Geschwindigkeiten vor und nach Regel\"anderung.}
\end{center}
\end{figure}
...
%% SOLUTIONS
\begin{solution}
Auf Basis der Visualisierung in Abbildung~\ref{fig:ch06-wilcoxplot1} k\"onnen R\"ange
f\"ur die beobachteten Geschwindigkeiten (innerhalb der Gesamtstichprobe) vergeben
werden (siehe Abbildung~\ref{fig:ch06-wilcoxplot1a}).
...
@
\caption{\label{fig:ch06-wilcoxplot1a} Beobachtete Geschwindigkeiten mit R\"angen.}
\end{center}
\end{figure}
