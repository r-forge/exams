...
if(runif(1) > 0.5) {
  ...
  solutions[1] <- F
  explanations[1] <- "Die Balken sind zwar gleich hoch, jede Gruppe f\\\\\"ur sich 
...
if(runif(1) > 0.5) {
  ...
  questions[1] <- "Die Balkenteile entsprechen Spaltenprozent f\\\\\"ur die gegebene Kreuztabelle."
  solutions[1] <- T
...
if(runif(1) > 0.5) {
  questions[2] <- "Mindestens die H\\\\\"alfte der befragten Bewohner direkt betroffener Gebiete hat sich 
  ...
  questions[2] <- "Ungef\\\\\"ahr ein Drittel (30-35 Prozent) der befragten Bewohner 
...
if(runif(1) > 0.5) {
  questions[3] <- paste( "Ungef\\\\\"ahr ($\\\\pm$ 2.5 Prozent)", round(rhp[1,2]/5)*5, "Prozent der befragten Bewohner 
                          indirekt betroffener Gebiete hat sich 
                          f\\\\\"ur st\\\\\"arkere Reglementierungen ausgesprochen.")
  solutions[3] <- T
  explanations[3] <- "Das ist die Interpretation des 2.Balkens als Spaltenprozent."                        
} else {
  questions[3] <- paste( "Ungef\\\\\"ahr ($\\\\pm$ 2.5 Prozent)", round(rhp[2,2]/5)*5, "Prozent aller befragten Bewohner 
                          hat sich gegen st\\\\\"arkere Reglementierungen ausgesprochen.")
  solutions[3] <- F
...
if(runif(1) > 0.5) {
  questions[3] <- paste( "Ungef\\\\\"ahr ($\\\\pm$ 2.5 Prozent)", round(rhp[2,3]/5)*5, "Prozent der befragten Bewohner 
  ...
  questions[3] <- paste( "Ungef\\\\\"ahr ($\\\\pm$ 2.5 Prozent)", round(rhp[1,3]/5)*5, "Prozent aller Befragten, die sich  
...
\begin{question}
Die Einstellung der Bev\"olkerung zur Transitfrage ist durch Massenmedien beeinflusst, aber nat\"urlich auch 
durch pers\"onliche Betroffenheit geformt. Bei einer Umfrage, ob eine st\"arkere Reglementierung des Schwerverkehrs 
