...
questions[2] <- paste("Die Anzahl der Freiheitsgrade betr\\\\\"agt $df = ", dff, "$.", sep="")  
solutions[2] <- dff==2
explanations[2] <- "Die Anzahl der Freiheitsgrade betr\\\\\"agt $df = 2$."
...
Ein $\chi^2$-Test zur \"Uberpr\"ufung von Unterschieden im Risikoverhalten 
