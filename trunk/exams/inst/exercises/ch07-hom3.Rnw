...
## 1. X2 interpretieren
if(runif(1) > 0.5) {
  questions[1] <- "Gro{\\\\ss}e Werte der Teststatistik sprechen eher gegen die Nullhypothese als kleine."
  solutions[1] <- TRUE
  explanations[1] <- "Die Werte der $X^2$-Teststatistik messen den Unterschied zwischen 
    beobachteten H\\\\\"aufigkeiten und 
    den unter der Nullhypothese erwarteten H\\\\\"aufigkeiten."
} else {
  questions[1] <- "Gro{\\\\ss}e Werte der Teststatistik sprechen eher f\\\\\"ur die Nullhypothese als kleine."
  solutions[1] <- FALSE
  explanations[1] <- "Die Werte der $X^2$-Teststatistik messen den Unterschied zwischen 
    beobachteten H\\\\\"aufigkeiten und 
    den unter der Nullhypothese erwarteten H\\\\\"aufigkeiten."
