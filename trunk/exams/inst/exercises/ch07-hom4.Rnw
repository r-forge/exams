...
## 1. X2 interpretieren
if(runif(1) > 0.5) {
  questions[1] <- "Gro{\\\\ss}e Werte der $X^2$-Teststatistik sprechen eher gegen die Nullhypothese als kleine."
  solutions[1] <- TRUE
  ...
  questions[1] <- "Gro{\\\\ss}e Werte der $X^2$-Teststatistik sprechen eher f\\\\\"ur die Nullhypothese als kleine."
  solutions[1] <- FALSE
  explanations[1] <- "$X^2$-Werte messen den Unterschied zwischen beobachteten H\\\\\"aufigkeiten und 
  den unter der Nullhypothese erwarteten H\\\\\"aufigkeiten."
}
