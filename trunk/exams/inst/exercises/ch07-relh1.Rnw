...
if(runif(1) > 0.5) {
  questions[1] <- "Tabelle 1 enth\\\\\"alt Angaben in Zeilenprozent."
  solutions[1] <- TRUE
...
if(runif(1) > 0.5) {
  questions[3] <- paste( "Die Eintragung in Zeile 1 und Spalte 1 von Tabelle 1 besagt:",
                         zoeffi[1,1], "Prozent derer, die das Angebot der \\\\\"offentlichen Verkehrsmittel
  ...
  questions[3] <- paste( "Die Eintragung in Zeile 4 und Spalte 2 von Tabelle 1 besagt:",
                         zoeffi[4,2], "Prozent derer, die das Angebot der \\\\\"offentlichen Verkehrsmittel
...
if(runif(1) > 0.5) {
  ...
  questions[4] <- paste( "Die Eintragung in Zeile 4 und Spalte 1 von Tabelle 2 besagt:",
                         ...
                         stufen das Angebot der \\\\\"offentlichen Verkehrsmittel als sehr schlecht ein.")
  solutions[4] <- FALSE
...
if(runif(1) > 0.5) {
  ...
  solutions[5] <- FALSE
  explanations[5] <- "Das w\\\\\"urde Gesamtprozent ergeben."
} 
...
Aus dieser wurden die folgende Tabellen mit relativen H\"aufigkeiten
ermittelt:
