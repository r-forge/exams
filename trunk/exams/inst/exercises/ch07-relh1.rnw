...
if(runif(1) > 0.5) {
  questions[1] <- "Tabelle 1 enthält Angaben in Zeilenprozent."
  solutions[1] <- T
  explanations[1] <- "Die Zeilensummen ergeben (von etwaigen Rundungsfehlern abgesehen) 100."
} else {
  questions[1] <- "Die Tabelle 2 enthält Angaben in Zeilenprozent."
  solutions[1] <- F
...
if(runif(1) > 0.5) {
  ...
  questions[1] <- "Die Tabelle 1 enthält Angaben in Spaltenprozent."
  solutions[1] <- F
...
if(runif(1) > 0.5) {
  questions[2] <- "Die Tabelle 2 gibt die Zufriedenheitsverteilung für die zwei Wohnorte an."
  solutions[2] <- T
...
if(runif(1) > 0.5) {
  questions[3] <- paste( "Die Eintragung in Zeile 1 und Spalte 1 von Tabelle 1 besagt:",
                         zoeffi[1,1], "Prozent derer, die das Angebot der öffentlichen Verkehrsmittel
  ...
  questions[3] <- paste( "Die Eintragung in Zeile 4 und Spalte 2 von Tabelle 1 besagt:",
                         zoeffi[4,2], "Prozent derer, die das Angebot der öffentlichen Verkehrsmittel
...
if(runif(1) > 0.5) {
  questions[3] <- paste( "Die Eintragung in Zeile 1 und Spalte 2 von Tabelle 1 besagt:",
                         zoeffi[1,2], "Prozent der Bewohner des Stadtrandes stuften das Angebot 
                         der öffentlichen Verkehrsmittel als sehr gut ein.")
  solutions[3] <- F
  explanations[3] <- "Das ist eine Interpretation als Spaltenprozent, es liegen aber Zeilenprozent vor."
} else {
  questions[3] <- paste( "Die Eintragung in Zeile 4 und Spalte 1 von Tabelle 1 besagt:",
                         zoeffi[4,1], "Prozent der Befragten waren Bewohner des Stadkernes und
...
if(runif(1) > 0.5) {
  questions[4] <- paste( "Die Eintragung in Zeile 2 und Spalte 1 von Tabelle 2 besagt:",
                         soeffi[2,1], "Prozent der Bewohner des Stadtkerns stufen das Angebot 
                         der öffentlichen Verkehrsmittel als eher gut ein.")
  solutions[4] <- T
  explanations[4] <- "Das ist die richtige Interpretation von Spaltenprozent."
} else {
  questions[4] <- paste( "Die Eintragung in Zeile 3 und Spalte 2 von Tabelle 2 besagt:",
                         soeffi[3,2], "Prozent der Bewohner des Stadtrandes stuften das Angebot 
                         der öffentlichen Verkehrsmittel als eher schlecht ein.")
  solutions[4] <- T
  explanations[4] <- "Das ist die richtige Interpretation von Spaltenprozent."
} 
} else
...
if(runif(1) > 0.5) {
  questions[4] <- paste( "Die Eintragung in Zeile 2 und Spalte 2 von Tabelle 2 besagt:",
                         soeffi[2,2], "Prozent derer, die das Angebot der öffentlichen Verkehrsmittel
  ...
  questions[4] <- paste( "Die Eintragung in Zeile 4 und Spalte 1 von Tabelle 2 besagt:",
                         ...
                         stufen das Angebot der öffentlichen Verkehrsmittel als sehr schlecht ein.")
  solutions[4] <- F
...
if(runif(1) > 0.5) {
  questions[5] <- "Tabelle 1 kann man aus der ursprünglichen Kreuztabelle auch selbst leicht ermitteln: 
                   Man ermittelt für jede Zeile Prozentwerte."
  solutions[5] <- T
...
if(runif(1) > 0.5) {
  ...
  solutions[5] <- F
  explanations[5] <- "Das würde Gesamtprozent ergeben."
} 
