...
if(runif(1) > 0.5) {
  questions[1] <- "Tabelle 2 enthält Angaben in Gesamtprozent."
  solutions[1] <- T
...
if(runif(1) > 0.5) {
  ...
  questions[3] <- paste( "Die Eintragung in Zeile 4 und Spalte 2 von Tabelle 2 besagt:",
                         goeffi[4,2], "Prozent der Befragten stuften das Angebot der öffentlichen Verkehrsmittel
...
if(runif(1) > 0.5) {
  ...
  solutions[5] <- F
  explanations[5] <- "Das würde Zeilenprozent ergeben."
} 
