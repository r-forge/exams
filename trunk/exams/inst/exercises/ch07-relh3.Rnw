...
if(runif(1) > 0.5) {
  questions[1] <- "Tabelle 2 enth\\\\\"alt Angaben in Zeilenprozent."
  solutions[1] <- T
  explanations[1] <- "Die Zeilensummen ergeben (von etwaigen Rundungsfehlern abgesehen) 100."
} else {
  questions[1] <- "Die Tabelle 1 enth\\\\\"alt Angaben in Zeilenprozent."
  solutions[1] <- F
...
if(runif(1) > 0.5) {
  ...
  questions[1] <- "Die Tabelle 1 enth\\\\\"alt Angaben in Gesamtprozent."
  solutions[1] <- F
...
if(runif(1) > 0.5) {
  questions[3] <- paste( "Die Eintragung in Zeile 3 und Spalte 1 von Tabelle 2 besagt:",
                         zoeffi[3,1], "Prozent derer, die das Angebot der \\\\\"offentlichen Verkehrsmittel
  ...
  questions[3] <- paste( "Die Eintragung in Zeile 2 und Spalte 2 von Tabelle 2 besagt:",
                         zoeffi[2,2], "Prozent derer, die das Angebot der \\\\\"offentlichen Verkehrsmittel
...
if(runif(1) > 0.5) {
  ...
  questions[3] <- paste( "Die Eintragung in Zeile 4 und Spalte 1 von Tabelle 2 besagt:",
                         ...
                         stuften das Angebot der \\\\\"offentlichen Verkehrsmittel als sehr gut ein.")
  solutions[3] <- F
...
if(runif(1) > 0.5) {
  ...
  questions[4] <- paste( "Die Eintragung in Zeile 3 und Spalte 2 von Tabelle 1 besagt:",
                         goeffi[3,2], "Prozent der Befragten stuften das Angebot der \\\\\"offentlichen Verkehrsmittel
...
\begin{question}
  ...
  mit dem Angebot an \"offentlichen Verkehrsmitteln durchgef\"uhrt. Ein
  Teilaspekt befasste sich mit der Frage, ob Bewohner des Stadtkerns
  zufriedener mit diesen Leistungen sind als Bewohner des Stadtrandes.
...
Aus dieser wurden die folgende Tabellen mit relativen H\"aufigkeiten ermittelt:
