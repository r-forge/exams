...
if(question == 1) {  
   questions[4] <- "Aufgrund des Testergebnisses kann man behaupten, dass 
                     ...
                     Parteien weisen."
   solutions[4] <- pv < 0.05
   explanations[4] <- paste("Der $p$-Wet ist gleich", format.pval(pv, digits = 3), "und damit wird die die Nullhypothese ",
...
Parteipr\"aferenzen zu den zwei Zeitpunkten zusammen gefasst:
