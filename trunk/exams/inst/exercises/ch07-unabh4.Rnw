...
if(runif(1) > 0.5) {
  questions[1] <- "Es sind mehr Befragte Raucher als Kaffeetrinker."
  ...
  questions[1] <- "Es sind weniger Befragte Nichtraucher als Kaffeetrinker."
...
Ein $\chi^2$-Test zur \"Uberpr\"ufung, ob der Konsum von Nikotin
unabh\"angig vom Konsum von Coffein ist, lieferte einen $X^2$-Wert von
$\Sexpr{x2}$.
