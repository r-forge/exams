...
expl <- character(4)
expl[1] <- paste("Von Stufe A1 zu Stufe A2 von Faktor A gibt es einen starken Anstieg",
                 "in den Mittelwerten. Bei Faktor B ist der Anstieg nur schwach.")
expl[2] <- paste("Von Stufe B1 zu Stufe B2 von Faktor B gibt es einen starken Anstieg",
...
expl[4] <- paste("In Stufe B1 ist der Unterschiede in den Mittelwerten zwischen den Faktorstufen A1 und A2",
...
if(runif(1) > 0.5) {
  ...
  solutions[1] <- FALSE
  explanations[2] <- paste(expl[dasm], " Daher ist der richtige Plot: ", dasm, ".", sep = "")
}
...
expl[2] <- paste("Von Stufe B1 zu Stufe B2 von Faktor B gibt es einen starken Anstieg",
                 "in den Mittelwerten. Bei Faktor A ist der Anstieg nur schwach.")
expl[3] <- paste("Sowohl von Stufe A1 zu Stufe A2 von Faktor A als auch von Stufe B1",
                 "zu Stufe B2 von Faktor B gibt es einen starken Anstieg in den Mittelwerten.")
...
if(runif(1) > 0.5) {
  questions[5] <- paste("Von Stufe A1 zu Stufe A2 von Faktor A gibt es einen starken Anstieg",
                        "in den Mittelwerten. Bei Faktor B ist das nicht der Fall.")
  solutions[5] <- dasm==1
  explanations[5] <- expl[dasm]
} else {
  questions[5] <- paste("Von Stufe B1 zu Stufe B2 von Faktor B gibt es einen starken Anstieg",
