...
expl[1] <- "Nur der Haupteffekt von Faktor A ist signifikant."
expl[2] <- "Nur der Haupteffekt von Faktor B ist signifikant."
expl[3] <- "Beide Haupteffekte A und B sind signifikant, nicht jedoch der Wechselwirkungeffekt."                   
...
jede Kombination der Faktoren sind in der folgenden Tabelle enthalten: 
