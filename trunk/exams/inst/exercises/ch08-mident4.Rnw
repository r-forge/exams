...
expl[2] <- "Die Aufnahme von Faktor Medium ergibt einen signifikanten Abfall in der RSS, 
            die weitere Aufnahme von Modellteilen nicht mehr."
expl[3] <- "Die Aufnahme beider Haupteffekte Marketing und Medium führt zu einem 
...
Die folgenden zwei Rechenergebnisse stammen aus einer zweifachen Varianzanalyse 
und zeigen die Residuenquadratsummen (RSS) 
vom einfachen Modell bis zum Wechselwirkungsmodell, 
wenn einmal zuerst 
der Faktor Marketing und wenn einmal zuerst der Faktor Medium 
