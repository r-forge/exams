...
quest[4] <- "Bei Werbung in Printmedien schneidet Werbung \\\\\"uber Qualit\\\\\"at besser ab, 
...
\begin{itemize}
  ...
  nur \"uber Qualit\"at aber nur im TV geworben wird, etc.).
...
%%%Die durchschnittlichen Verkaufszahlen in den Testregionen enthaelt 
