...
expl[1] <- "Nur der Haupteffekt von Faktor Marketing ist signifikant."
expl[2] <- "Nur der Haupteffekt von Faktor Medium ist signifikant."
expl[3] <- "Beide Haupteffekte Marketing und Medium sind signifikant, 
            nicht jedoch der Wechselwirkungeffekt."                   
expl[4] <- "Der Wechselwirkungeffekt ist signifikant."   
...
expl[4] <- "Bei Zeitungswerbung schneidet Werbung über Qualität besser ab, 
...
quest[3] <- "Sowohl beim Faktor Marketing als auch beim Faktor Medium gibt es einen 
             starken Abfall in den Mittelwerten, wenn man die erste mit der zweiten Stufe
             des Faktors vergleicht."                   
quest[4] <- "Bei Zeitungswerbung schneidet Werbung über Qualität besser ab, 
             bei TV-Werbung ist Werbung über Preis besser."    
...
\begin{itemize}
  ...
  \item Wo soll geworben werden (Faktor Medium)? 
        ...
        über Zeitungen geworben werden?
  \end{itemize}
...
Zeitungen geworben wird, es gibt anderen Testmarkt, in dem nur über Qualität aber nur  
im TV geworben wird, etc.).

Die Verkaufszahlen Y in jeweils 10 Supermärkten pro Testmarkt werden beobachtet.

Als Methode kommt eine zweifache Varianzanalyse zum Einsatz.

Aus der folgenden Varianzanalysetabelle sollen die signifikanten  
Effekte (Haupt- bzw. Wechselwirkungseffekte) abgeleitet werden.
