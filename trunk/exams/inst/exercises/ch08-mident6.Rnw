...
zf1 <- c(-10.3, -20.1, 11.4, 9.4,  17.6, -2.9, -6.6, -19.2, -4.5, -3.5, 13.3, -21.3, 
           8.7,  23.6, 13.6, 9.9, -24.4,  2.4,  6.5, -11.7)

zf <- c( zf1, sample(zf1), 0.98*zf1, 1.02*zf1 ) + rnorm(80,sd=3)
...
poseff <- ( runif(1,-1,1)<0 )   #### haupteffekte wirken positiv
if( poseff ){ beta <- -beta
              beta[1] <- 300 - beta[4]}  
