...
explanations[3] <- paste("Das Bestimmtheitsma{\\\\ss} wird berechnet aus $B = 1-RSS_{M_12}/RSS_{M_0}$ = ",
...
explanations[4] <- paste("Das Bestimmtheitsma{\\\\ss} wird berechnet aus $B = 1-RSS_{M_12}/RSS_{M_0}$ = ",
	round(summary(fm23)$r.squared,2), ".",sep="")  
