...
In Abbildung~\ref{fig:ch10-tree1} sehen Sie den Baum zur Modellwahl,
der auf Modellvergleichen mittels der ANOVA basiert.
...
selectplot(M0,M1,M2,M12,name=TRUE,RSS=TRUE,pvalue=TRUE)
@
\caption{\label{fig:ch10-tree1} Baum zur Modellwahl}
\end{center}
\end{figure}
