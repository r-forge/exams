...
explanations[1] <- paste("Denn der $p$-Wert ist ungef\\\\\"ahr ", format(round(anova(fm1,fm2)[2,6],4),scientific=FALSE), ".", sep="")  
...
explanations[2] <- paste("Denn der $p$-Wert ist ungef\\\\\"ahr ", format(round(anova(fm3,fm23)[2,6],4),scientific=FALSE), ".", sep="")  
