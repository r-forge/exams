...
explanations[1] <- paste("Dieser Test wird in der 3. Tabelle durchgef\\\\\"uhrt. 
	Dort ist der $p$-Wert ungef\\\\\"ahr ", format(round(anova(fm1,fm2)[2,6],4),scientific=FALSE), ".",seps="")  
...
explanations[2] <- paste("Dieser Test wird in der 2. Tabelle durchgef\\\\\"uhrt. 
	Dort ist der $p$-Wert ungef\\\\\"ahr ", format(round(anova(fm3,fm23)[2,6],4),scientific=FALSE), ".",seps="")  
