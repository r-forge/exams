...
\begin{question} 
Gegeben sind die Renditen des Dow-Jones-Industrial Index in Prozent, $r_t$, f\"ur 
die Periode \Sexpr{rtstart} bis \Sexpr{rtend}, w\"ochentliche Daten, mit der L\"ange 
$n =100$. 
...
Berechnen Sie eine 3-Schritt Prognose f\"ur die Renditen, $r_{100}(3)$. 
...
Die 1-Schritt Prognose f\"ur $t=(n+1)$ bei gegebenen Renditen bis $t=n$ ist
