...
Estimate the expected amount of money spent of continuing education
for a firm with \Sexpr{X} employees using least squares regression.
\end{question}
...
The estimated amount of money spent for a firm with
