...
create_table <- function() {
  ...
  countryside <- rmultinom(1, 150, prob=c(0.1, 0.2, 0.4, 0.3))
  matrix(c(city, countryside), nrow = 4,
...
questions[1] <- paste("Table 1 contains ", percentage[variant1], "percentages.")
...
if (runif(1) > 0.5) {
  questions[2] <- "Table 1 gives the location distribution for each level of satisfaction."
  ...
  questions[2] <- "Table 1 gives the satisfaction distribution for each location type."
...
if (question == 1) {
  questions[3] <- if (runif(1) > 0.5) paste("The value in row 1 and column 1 in Table 1 indicates:", prop_public[1,1], 
  "percent of those, who evaluated the offered public transportation as very good,",
  "live in a city.") else paste("The value in row 4 and column 2 in Table 1 indicates:", prop_public[4,2], 
  "percent of those, who evaluated the offered public transportation as very bad,",
  ...
  questions[3] <- paste("The value in row 1 and column 2 in Table 1 indicates:", prop_public[1,2], 
                        "percent of those living in the coutryside evaluated the public transportation ",
                        "offered as very good.")
  ...
  questions[3] <- paste("The value in row 4 and column 1 in Table 1 indicates:", prop_public[4,1], 
                         "percent of the respondents live in the city center and evaluated the ",
                        "public tranportation offered as very bad.")
...
if (question == 1) {
  if (runif(1) > 0.5) {
    questions[4] <- paste("The value in row 2 and column 1 von Table 1 indicates:", prop_public[2,1], 
                          "percent of the respondents in the city evaluated the public transportation offered as good.")
  } else {
    questions[4] <- paste("The value in row 3 and column 2 von Table 1 indicates:", prop_public[3,2], 
                          "percent of the respondents in the countryside evaluated the public transportation ",
                          "offered as bad.")
  } 
  ...
  questions[4] <- paste("The value in row 2 and column 2 von Table 1 indicates:", prop_public[2,2], 
                        "percentage of those, who evaluated the offered public transportation as good",
                        "live in the countryside.")
  ...
  questions[4] <- paste("The value in row 3 and column 1 von Table 1 indicates:", prop_public[3,1], 
                        "percent of the respondents lived in the city and evaluated",
                        "the offered public transportation as bad.")
...
question <- sample(1:3, 1)
if (question == 1) {
  questions[5] <- paste("Table 1 can be easily constructed from the original cross-tabulation:",
...
\begin{question}
  In a small country the satisfaction with the offered public
  transportation is analyzed. One aspect of the analysis is if
  inhabitants of a city are more satisfied with pulic transportation
  than those living in the countryside.

  A survey with 250 respondents gave the following cross-tabulation:
<<echo=FALSE>>= 
public
@
...
\begin{solution}
<<echo=FALSE>>=
interpretation <- c("the location distributions for each level of satisfaction are given.",
                    "the satisfaction distributions for each location type are given.",
                    "the relative frequencies (in percentage) for location and satisfaction level are given.")
@ 

In Table 1 the \Sexpr{rowsums[variant]} are about 100 (except for
possible rounding errors). Hence the table provides
\Sexpr{percentage[variant]} percentages. This signifies that
