...
if (question == 1) {
  ...
  "live in the city centre.") else paste("The value in row 4 and column 2 in Table 1 indicates:", prop_public[4,2], 
  ...
  questions[3] <- paste("The value in row 1 and column 2 in Table 1 indicates:", prop_public[1,2], 
                        "percent of those living in the suburb evaluated the public transportation ",
...
if (question == 1) {
  if (runif(1) > 0.5) {
    questions[4] <- paste("The value in row 2 and column 1 von Table 1 indicates:", prop_public[2,1], 
                          "percent of the respondents in the city centre evaluated the public transportation offered as good.")
  } else {
    questions[4] <- paste("The value in row 3 and column 2 von Table 1 indicates:", prop_public[3,2], 
                          "percent of the respondents in the suburb evaluated the public transportation ",
                          "offered as bad.")
  } 
...
\begin{question}
  In a small city the satisfaction with the offered public
  transportation is evaluated. One aspect of the analysis is if
  inhabitants of the city centre are more satisfied with pulic
  transportation than those living in the suburb.
