...
questions[1] <- "The absolute value of the test statistics is larger than 1.96."
solutions[1] <- abs(tt$statistic) > 1.96
explanations[1] <- paste("The absolute value of the test statistics is equal to ", 
...
\begin{question}
  ...
  chains with different cashier systems are compared. The following
