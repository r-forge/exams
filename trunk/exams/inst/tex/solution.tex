...
\ID{YYMMDD00001}
\Date{YYYY-MM-DD}
\newcommand{\theID}{07102600001} %%FIXME \@ID
\newcommand{\theDate}{2007-10-26} %%FIXME \@Date

%% \exinput{header}

%% header
\markboth{\textnormal{\bf \large Klausur Statistik: \theID}}%
{\textnormal{\bf \large Klausur Statistik: \theID}}
