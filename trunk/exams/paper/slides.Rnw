...
\begin{frame}[allowframebreaks] 
  ...
  \item Gr\"un B, Zeileis A (2009).
    \newblock \enquote{Automatic Generation of Exams in R.}
    \newblock Journal of Statistical Software, \textbf{29}(10), 1--14.
    \newblock
    \urlprefix\url{http://www.jstatsoft.org/v29/i10/}.
  ...
  \item \proglang{R} Development Core Team (2011).
