...
\begin{frame}[allowframebreaks,fragile] 
  ...
  \begin{itemize}
  \item {\bf Two environments:} a question and a solution description
    encapsulated in corresponding \LaTeX environments.
  \item {\bf Meta-information:} about type of questions
...
\item inclusion of a suitable cover page with answer fields, and
...
\end{itemize}
\end{frame}
\subsection{Application and Customization: Function
    \code{exams()}}
\begin{frame}[allowframebreaks,fragile] 
...
\begin{frame}[allowframebreaks] 
  ...
  \small
  \begin{references}
  \item Gr\"un B, Zeileis A (2008).
    \newblock \enquote{Automatic Generation of Simple (Statistical) Exams.}
    \newblock \emph{Report~77}, Department of Statistics and Mathematics,
    WU Wien, Research Report Series.
    \newblock
    \urlprefix\url{http://epub.wu-wien.ac.at/dyn/openURL?id=oai:epub.wu-wien.ac.%
      at:epub-wu-01_e1d}.
