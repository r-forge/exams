...
<xsl:template match="/atom:feed">
	...
	<link rel="stylesheet" type="text/css" href="http://r-exams.org/assets/css/styles_feeling_responsive.css" />
	<script src="http://r-exams.org/assets/js/modernizr.min.js"></script>
...
<meta name="theme-color" content="#1f7a7a">
	...
	<meta property="og:url" content="http://r-exams.org//assets/xslt/atom.xslt" />
	...
	<link type="text/plain" rel="author" href="http://r-exams.org/humans.txt" />
...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
          <a href="http://r-exams.org">
            <img class='nav-logo' src="http://r-exams.org/assets/img/logo.svg" alt="R/exams">
          </a>
          <!-- <h1 class="show-for-small-only"><a href="http://r-exams.org" class="icon-tree"> R/exams</a></h1> -->
      </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li class="has-dropdown">
                <a href="http://r-exams.org/">R/exams</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a href="http://r-exams.org/intro/elearning/">E-Learning</a></li>
                    

                      

                      <li><a href="http://r-exams.org/intro/oneforall/">One-for-All</a></li>
                    

                      

                      <li><a href="http://r-exams.org/intro/written/">Written Exams</a></li>
                    

                      

                      <li><a href="http://r-exams.org/intro/dynamic/">Dynamic Exercises</a></li>
              ...
              <li><a href="http://r-exams.org/tutorials/">Tutorials</a></li>
              <li class="divider"></li>
              ...
              <li><a href="http://r-exams.org/templates/">Exercise Templates</a></li>
              <li class="divider"></li>
              ...
              <li><a href="http://r-exams.org/blog/">Blog</a></li>
              <li class="divider"></li>
      ...
      <ul class="right">
              ...
              <li class="divider"></li>
              <li><a href="http://r-exams.org/resources/">Resources</a></li>
              ...
              <li class="divider"></li>
              <li><a href="http://r-exams.org/contact/">Contact</a></li>
              ...
              <li class="divider"></li>
              <li><a href="http://r-exams.org/search/">Search</a></li>
...
<!-- <div id="masthead-no-image-header"> -->
	<!-- <div class="row"> -->
		<!-- <div class="small-12 columns"> -->
			<!-- <a id="logo" href="http://r-exams.org" title="R/exams – The One-for-All Exams Generator"> -->
				<!-- <img src="http://r-exams.org/assets/img/logo.svg" alt="R/exams – The One-for-All Exams Generator"> -->
			<!-- </a> -->
        ...
        <div class="row">
          <div class="medium-6 large-5 columns">
            ...
            <p class="shadow-black">
              ...
              <!-- <a href="http://r-exams.org/about/">More ›</a> -->
            </p>
          </div><!-- /.large-6.columns -->
        ...
        <nav class="row">
          ...
          <section id="subfooter-right" class="small-12 medium-6 columns social-icons">
            <ul class="inline-list">
              ...
              <li><a href="mailto:bugs@R-exams.org" target="_blank" class="icon-bug" title="Bug reports"></a></li>
...
<script src="http://r-exams.org/assets/js/javascript.min.js"></script>
<script src="http://r-exams.org/assets/js/slick.min.js"></script>
